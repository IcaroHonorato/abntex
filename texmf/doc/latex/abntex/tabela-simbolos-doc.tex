%% $Id: tabela-simbolos-doc.tex,v 1.8 2005/11/08 21:40:09 gweber Exp $
%% Copyright 2003-2005 by the abnTeX group at http://codigolivre.org.br/projects/abntex
%%
...
\def\Versao$#1 #2${#2}
\def\Data$#1 #2 #3${#2}
\def\DataCVS{\Data$Date: 2005/11/08 21:40:09 $}
\def\VersaoCVS{\Versao$Revision: 1.8 $}
\begin{document}
